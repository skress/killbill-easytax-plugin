...
public interface EasyTaxDao {
     ...
     * </p>
     *
     * @param taxCode the tax code details to save
     ...
     * </p>
     *
     * @param taxCodes the tax code details to save
     * @throws SQLException if any SQL error occurs
     */
     ...
     * @param taxZone     if provided, only delete tax codes matching this tax zone
     * @param productName if provided, only delete tax codes matching this product name
     * @param taxCode     if provided, only delete tax codes matching this tax code
     ...
     *
     * @param kbTenantId  the tenant ID
     * @param taxZone     an optional tax zone to limit the results to
     * @param productName an optional product name to limit the results to
     * @param taxCode     an optional tax code to limit the results to
     * @param date        an optional validity date to limit the results to
     ...
     * </p>
     *
     * @param taxation the taxation to save
     * @throws SQLException if any SQL error occurs
     */
     ...
     *
     * @param kbTenantId  the tenant ID
     * @param kbAccountId the account ID
     * @param kbInvoiceId the invoice ID
